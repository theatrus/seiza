...
- **Parameterized stretch** — `seiza_rendered_image_open_with_stretch_config`
  ...
  expensive processing while committed renders remain full resolution. New
  processing capabilities remain in their core crates; this shim only marshals
  JSON in and pixels out.
