...
```json
{"jsonrpc":"2.0","id":1,"result":{"protocolVersion":1,"server":{"name":"seiza","version":"0.7.2"},"client":{"name":"N.I.N.A.","version":"4.x"},"capabilities":{"solveModes":["hinted","blind"],"imageInputs":["image_path"],"maxConcurrentRequests":1},"catalog":{"starCount":154100000,"blindIndexLoaded":true,"blindIndexPatternCount":1234567,"blindIndexMagnitudeLimit":16.0}}}
```
